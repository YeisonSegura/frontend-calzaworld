...
export const insertarUsuario = async (nuevoUsuario) => {
    try {
        const respuesta = await fetch("https://backend-calzaworld.onrender.com/api/usuarios", {
            method: "POST",
            headers: {
...
export const actualizarUsuarios = async (usuarioActualizado) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/usuarios/${usuarioActualizado.u_id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
export const eliminarUsuarios = async (idusuario) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/usuarios/${idusuario}`, {
            method: "DELETE"
        });
...
export const insertarProveedores = async (nuevoProveedor) => {
    try {
        const respuesta = await fetch("https://backend-calzaworld.onrender.com/api/proveedores", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export const actualizarProveedores = async (proveedorActualizado) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/proveedores/${proveedorActualizado.p_id_proveedor}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
export const eliminarProveedor = async (idproducto) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/proveedores/${idproducto}`, {
            method: "DELETE"
        });
...
export const insertarClientes = async (nuevoCliente) => {
    try {
        const respuesta = await fetch("https://backend-calzaworld.onrender.com/api/clientes", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export const actualizarClientes = async (clienteActualizado) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/clientes/${clienteActualizado.c_id_cliente}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
export const eliminarClientes = async (idCliente) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/clientes/${idCliente}`, {
            method: "DELETE"
        });
...
export const insertarVentas = async (nuevoVenta) => {
    try {
        const respuesta = await fetch("https://backend-calzaworld.onrender.com/api/ventas", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export const actualizarVentas = async (ventaActualizada) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/ventas/${ventaActualizada.v_id_venta}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
export const eliminarVentas = async (idVenta) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/ventas/${idVenta}`, {
            method: "DELETE"
        });
...
export const insertarProducto = async (nuevoProducto) => {
    try {
        const respuesta = await fetch("https://backend-calzaworld.onrender.com/api/productos", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export const actualizarProductos = async (productoActualizado) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/productos/${productoActualizado.p_id_producto}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
...
export const eliminarProductos = async (idProducto) => {
    try {
        const respuesta = await fetch(`https://backend-calzaworld.onrender.com/api/productos/${idProducto}`, {
            method: "DELETE"
        });
